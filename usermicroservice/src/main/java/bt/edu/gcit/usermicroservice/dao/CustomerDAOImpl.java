...
public class CustomerDAOImpl implements CustomerDAO {
   ...
   public Customer findByVerificationCode(String code) {
      TypedQuery<Customer> query = entityManager
            .createQuery("SELECT c FROM Customer c WHERE c.verificationCode = :code", Customer.class);
   ...
   public boolean isEmailUnique(String email) {
      TypedQuery<Long> query = entityManager.createQuery("SELECT COUNT(c) FROM Customer c WHERE c.email = :email",
            Long.class);
      query.setParameter("email", email);
